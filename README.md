...
4. [`docs/04_PIPELINE_OPERATIONS.md`](docs/04_PIPELINE_OPERATIONS.md) — orchestrator usage, monitoring, recovery (v0.8.3)
...
| Path | What's in it |
|---|---|
| `powershell/Run-Pipeline.ps1` | **The orchestrator** — single script that drives the entire pipeline (v0.8.3+) |
